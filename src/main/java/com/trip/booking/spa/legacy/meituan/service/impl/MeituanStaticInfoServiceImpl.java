...
import com.trip.booking.spa.gateway.adapter.outbound.state.dao.entity.SupplierHotelIdList;
import com.trip.booking.spa.gateway.domain.shared.Constants;
import com.trip.booking.spa.gateway.domain.supplier.SupplierSourceEnum;
import com.trip.booking.spa.gateway.adapter.outbound.state.dao.mapper.SupplierHotelIdListMapper;
import com.trip.booking.spa.legacy.meituan.access.HotelInfoAccess;
import com.trip.booking.spa.legacy.meituan.access.HotelListAccess;
import com.trip.booking.spa.legacy.meituan.access.ProductInfoAccess;
import com.trip.booking.spa.legacy.meituan.access.RoomInfoAccess;
import com.trip.booking.spa.legacy.meituan.adaptor.MeiTuanStaticInfoAdaptor;
...
import com.trip.booking.spa.legacy.meituan.bean.response.HotelInfoResponse;
...
public class MeituanStaticInfoServiceImpl implements MeituanStaticInfoService {
    ...
    public void saveHotelInfo(List<Long> hotelIds) {
        ...
        try {
            ...
            hotelInfoPlaceholderClient.saveHotelInfo(list);
            ...
            for (Long hotelId : hotelIds) {
                if (realRoomInfoMap.containsKey(hotelId)) {
                    ...
                    if (CollectionUtils.isNotEmpty(supplierRoomBaseRequests)) {
                        hotelInfoPlaceholderClient.saveRoomInfo(supplierRoomBaseRequests);
                    }
                }
            }
        } catch (RedisLimitException e) {
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(supplierProductBaseRequests)) {
                ...
                for (int i = 0; i < supplierProductBaseRequests.size(); i += batchSize) {
                    ...
                    hotelInfoPlaceholderClient.saveProductInfo(saveSupplierProductInfo);
                    currentBatch++;
                }
            }
