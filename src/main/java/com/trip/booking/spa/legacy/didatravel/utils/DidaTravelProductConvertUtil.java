package com.trip.booking.spa.legacy.didatravel.utils;
...
import com.trip.booking.spa.legacy.inittimezone.InitTimeZoneServiceImpl;
...
import com.trip.booking.spa.platform.util.ZoneHttpUtils;
...
//            record.type = parts[10];
     ...
     * @return: com.trip.booking.spa.gateway.domain.shared.GeonamesCityInfo
     **/
...
//        log.info("getCityInfoByGeonames intput:{}",input);
     ...
     * @param: [input]
     * @return: java.util.List<com.trip.booking.spa.gateway.domain.shared.GeonamesCityInfo>
     **/
