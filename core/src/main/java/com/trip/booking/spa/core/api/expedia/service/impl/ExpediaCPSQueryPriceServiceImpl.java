                    ...
                    for (ExpediaQueryPriceTask expediaQueryPriceTask : list) {
                        ...
                        try {
                            ...
                            if (QueryPriceQueueSwitch == 1) {
                                request = PriceReq.builder().adultNum(2).childNum(0).guestType(0).childAges(new ArrayList<>()).checkIn(currentCheckin.toString()).checkout(currentCheckout.toString()).roomNum(1).build();
