...
import com.trip.booking.spa.core.api.aichotels.utils.AichotelsProductConvertUtil;
...
import com.trip.booking.spa.core.api.ratehawk.access.CheckPriceAccess;
import com.trip.booking.spa.core.api.ratehawk.access.HotelFileAccess;
import com.trip.booking.spa.core.api.ratehawk.access.QueryProductAccess;
import com.trip.booking.spa.core.api.ratehawk.adaptor.RateHawkStaticInfoAdaptor;
import com.trip.booking.spa.core.api.ratehawk.bean.request.CheckPriceRequest;
import com.trip.booking.spa.core.api.ratehawk.bean.request.HotelInfoRequest;
import com.trip.booking.spa.core.api.ratehawk.bean.request.QueryProductRequest;
import com.trip.booking.spa.core.api.ratehawk.bean.response.CancellationInfo;
import com.trip.booking.spa.core.api.ratehawk.bean.response.CheckPriceResponse;
import com.trip.booking.spa.core.api.ratehawk.bean.response.HotelFileResponse;
import com.trip.booking.spa.core.api.ratehawk.bean.response.HotelStaticInfo;
            ...
            ThreadPoolUtils.execute(() -> {
                ...
                try {
                    ...
                    if (null != queryProductResult.getData() && CollectionUtils.isNotEmpty(queryProductResult.getData().getHotels())) {
                        //推送info
                        hotelInfoPlaceholderClient.saveProductInfo(RateHawkStaticInfoAdaptor.transformInfoProductReq(queryProductResult.getData()));
                    } else {
...
//            return disProductInfo(productRespList);
        ...
        //插入缓存
        cachePriceService.productToCache(productRespList, request);
        return productRespList;
    }
