package com.trip.booking.spa.core.api.didatravel.service.impl;

import com.alibaba.fastjson.JSON;
import com.trip.booking.spa.core.placeholder.hotelbase.enums.BedTypeAllEnum;
import com.trip.booking.spa.core.placeholder.hotelbase.enums.BedTypeExpediaEnum;
...
import com.trip.booking.spa.core.placeholder.hotelinfo.enums.BroadnetEnum;
...
import com.trip.booking.spa.core.api.didatravel.access.BedTypeAccess;
import com.trip.booking.spa.core.api.didatravel.access.DidaTravelAccess;
import com.trip.booking.spa.core.api.didatravel.access.PriceConfirmAccess;
import com.trip.booking.spa.core.api.didatravel.access.SearchAccess;
import com.trip.booking.spa.core.api.didatravel.access.StaticInfoAccess;
import com.trip.booking.spa.core.api.didatravel.bean.BedTypeList;
import com.trip.booking.spa.core.api.didatravel.bean.CheckPriceResponse;
import com.trip.booking.spa.core.api.didatravel.bean.GetBedTypeListRSSuccess;
import com.trip.booking.spa.core.api.didatravel.bean.HotelType;
import com.trip.booking.spa.core.api.didatravel.bean.HotelTypeRatePlan;
...
import com.trip.booking.spa.core.api.didatravel.bean.price.priceConfirm.PriceConfirmRequest;
...
//                        .setBrandName()
    ...
    public void saveRoomInfoSupplier(List<String[]> csvData, String startDate, String endDate) {
        ...
        try {
            ...
            InfoResult<List<SupplierHotelBaseResponse>> listHotelBaseResult = hotelInfoPlaceholderClient.queryHotelList(queryHotelRequest);
            ...
            for (int i = 0; i < requestAllHotelIds.size(); i += batchSize) {
                ...
                for (HotelType hotelType : hotelList) {
                    ...
                    hotelInfoPlaceholderClient.saveRoomInfo(supplierRoomBaseSubRequest);
                    log.info("插入产品数量：{}", supplierProductBaseRequests.size());
                    hotelInfoPlaceholderClient.saveProductInfo(supplierProductBaseRequests);
                }
