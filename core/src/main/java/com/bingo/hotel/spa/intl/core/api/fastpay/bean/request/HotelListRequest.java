...
package com.bingo.hotel.spa.intl.core.api.fastpay.bean.request;
...
public class HotelListRequest {
    ...
    private OffsetDateTime fromLastUpdateDate;

    private OffsetDateTime toLastUpdateDate;
    ...
    public OffsetDateTime getFromLastUpdateDate() {
        return fromLastUpdateDate;
    }

    public void setFromLastUpdateDate(OffsetDateTime fromLastUpdateDate) {
        this.fromLastUpdateDate = fromLastUpdateDate;
    }

    public OffsetDateTime getToLastUpdateDate() {
        return toLastUpdateDate;
    }

    public void setToLastUpdateDate(OffsetDateTime toLastUpdateDate) {
        this.toLastUpdateDate = toLastUpdateDate;
    }
}
