...
public class AichotelsHotelServiceImpl implements AichotelsHotelService {
    ...
    public void getHotelCodeListByCity(String city) {
        ...
        for (CityListResponse.CityListBean cityListBean : cityResponse.getData().getCity_list()) {
            ...
            log.info(JsonUtils.writeObject2Json(infoResult) + "=======" + cityListBean.getName() + ":" + request.size());
        }
    }

    public static void main(String[] args) {
        String date = Encryption.getDate();
        String apiClientToken = Encryption.generateSignature("GET", "/content/public/single_hotel/71006186", date, "UBiz3ZX58INhgioxv9ToAK2VqbQRe3f3Fp8v");
        ResponseResult<SingleHotelResponse> response = new SingleHotelAccess("https://api-uat.aichotels.net.cn/content/public/single_hotel/71006186?locale=zh_CN", "BaoShengTest", date, apiClientToken).access(null);
